...
| movement | enum | sitting, standing, walking, lifting |
| rpe | int | Rate of Perceived Exertion (1 to 10) |
...
| result | enum | if past competition: win, loss, draw, free text field for additional thoughts (type of loss and win) |
